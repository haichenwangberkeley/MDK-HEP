...
- The metadata CSV artifact is the authoritative source for cross section, k-factor, filter efficiency, and signed generator-weight sums in this repository. Some legacy repo layouts place it at `skills/metadata.csv`.
