...
1. Read `skills/pipelines/hep_analysis_meta_pipeline.md` first for the full stage map.
2. If the task is only about spec intake or execution-contract setup, read `skills/pipelines/spec_to_runtime_pipeline.md`.
3. If the task is only about plotting, report assembly, or handoff, read `skills/pipelines/reporting_and_handoff_pipeline.md`.
...
5. Load only the specific repo-local pattern files needed for the current blocker. Do not fall back to the legacy `.codex/skills/hep-meta-first/references/` contracts.
