...
1. Read only the bundled reviewer reference that matches the current gate:
   ...
   - `../_hep-analysis-refactored/skills/reviewers/reproducibility_and_handoff_reviewer.md`
2. Pair the reviewer with:
   - `../_hep-analysis-refactored/skills/shared/review_rubric.md`
   - `../_hep-analysis-refactored/skills/shared/evidence_requirements.md`
